...
export const conceptCache = new LRUCache<unknown>(500, 60);
export const hierarchyCache = new LRUCache<unknown>(200, 30);
export const vocabularyCache = new LRUCache<unknown>(10, 60);
